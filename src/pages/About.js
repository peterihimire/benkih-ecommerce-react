            ...
            <div className="about-text-div">
              <div className="about-text">
                ...
                <p>
                  ...
                  competitors, ranging from individuals and small businesses all
                  the way to large enterprice corporations.
                </p>
              </div>
              ...
              <div className="about-text">
                ...
                <p>
                  ...
                  very collaborative. I like to involve my clients closely in
                  every stage of the project, listening and fully understanding
                  their requirements so as to deliver an online solution that
              ...
              <div className="about-text">
                <h4>ownership</h4>
                <p>
                  When am not programming, you'll find me in my home studio
                  cooking up some youtube tech videos, where I share my thoughts
                  about mobile technologies. Click to download my
                  <a
